...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package modus-vivendi-theme
    ...
    (set-face-attribute 'default nil :height 95 :font "JetBrains Mono")
    ;; (global-fira-code-mode t)
     (set-face-attribute 'mode-line nil :box '(:line-width 1 :color "#664466"))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; TODO: send http://cachestocaches.com/2017/3/complete-guide-email-emacs-using-mu-and-/#using-mu4e-to-send-mail
  (require 'mu4e)
  (setq-default user-mail-address "zarkonesmall@gmail.com")
#+END_SRC
** telega
#+BEGIN_SRC emacs-lisp
  (use-package telega
