...
#+BEGIN_SRC emacs-lisp
  ...
  (defun insert-anatolii-todo ()
    "Inserts commented TODO: Anatolii"
    (interactive)
    (let ((todo-text "TODO: Anatolii"))
      (insert todo-text)
      (forward-line)
      (comment-line -1)
      (forward-line)))
...
** OSX
   #+begin_src emacs-lisp
     (defun me/switch-modifiers ()
       "Switch modifiers in macos when I plug HHKB"
       (interactive)
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package modus-vivendi-theme
    ...
    (set-face-attribute 'default nil :height 125 :font "Droid Sans Mono SW")
    ...
    (set-face-attribute 'region nil :background "#727")
